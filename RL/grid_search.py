...
from RL.create_data import create_dummy_dataset
...
if __name__ == "__main__":
    ...
    dummy = create_dummy_dataset(data)
    df_train, df_val, df_test = time_split(df_dict=dummy, train_ratio=0.8, val_ratio=0.15)
    ticker = "LKOH"
